...
public:
    ...
    static QString TxIdLink(const QString& txHash)
    {
        ...
        {
            return QString(SINOVATE_EXPLORER_MAINNET).arg("tx", txHash);
        }
        else if(instance().network == "test")
        {
            return QString(SINOVATE_EXPLORER_TESTNET).arg("tx", txHash);
        }
...
QString TransactionDesc::toHTML(interfaces::Node& node, interfaces::Wallet& wallet, TransactionRecord *rec, int unit)
{
    ...
    strHTML += TransactionFormater::ItemNameColor(tr("Net amount")) + BitcoinUnits::formatHtmlWithUnit(unit, (wtx.is_coinstake ? nTotalStake : nNet), true) + "<br>";
