...
static RPCHelpMan getblock()
{
    return RPCHelpMan{"getblock",
                ...
                RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::STR_HEX, "previousblockhash", /* optional */ true, "The hash of the previous block (if available)"},
                    {RPCResult::Type::STR_HEX, "nextblockhash", /* optional */ true, "The hash of the next block (if available)"},
                    {RPCResult::Type::STR, "flags", "The flag for proof attributes of the block"},
                    {RPCResult::Type::STR, "stakeModifier", /* optional */ true, "The string representing the stakeModifier of the block (if available)"},
                    {RPCResult::Type::STR_HEX, "hashProofOfStake", /* optional */ true, "The hash of the proof-of-stake (if available)"},
                }},
